...
export function InputBox(prop:input){
    return <div className="flex relative w-screen ">
        
        <div className="absolute top-3.5 left-3 text-emerald-400/60 focus:bg-white/15">{prop.children}</div>
        <input type={prop.type} placeholder={prop.text} className="  content1 p-3 pl-12 w-auto  w-fullbg-white/10 border font-normal 
