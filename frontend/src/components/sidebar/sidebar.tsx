...
export function Sidebar(){
    ...
    return <div className="w-64 bg-white/10  backdrop-blur-xl border-r border-white/20 flex flex-col">
        ...
        <nav className=" flex flex-1 p-4   relative ">
            <div className=" space-y-4 mt-10 ">

            {items.map((x)=>(<div
            key={x.id} 
            onClick={()=>{setSelected(x.id)}} 
            className={`flex px-10 py-3 space-x-3 max-w-full justify-around  rounded-lg  items-center transition-all duration-300
